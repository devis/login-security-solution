	...
	protected function set_fields() {
		$this->fields = array(
			...
			'pw_complexity_exemption_length' => array(
				'group' => 'pw',
				'label' => __("Complexity: Password Length Exemption", 'login-security-solution'),
			...
			'pw_min_age_change_days' => array(
				'group' => 'pw',
				'label' => __("Minimum Age", 'login-security-solution'),
				'text' => __("How many days old must a password be before allowing it be changed? Not recommended. 0 disables this feature.", 'login-security-solution'),
				'type' => 'int',
			),
			'pw_max_age_change_days' => array(
				'group' => 'pw',
				'label' => __("Maximum Age", 'login-security-solution'),
