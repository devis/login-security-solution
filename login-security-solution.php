	...
	protected function msg($code) {
		...
		switch ($code) {
			...
			case self::E_LOWERCASE:
				return sprintf(__("Passwords must either contain lower-case letters or be %d characters long.", 'login-security-solution'), $this->options['pw_complexity_exemption_length']);
			case self::E_UPPERCASE:
				return sprintf(__("Passwords must either contain upper-case letters or be %d characters long.", 'login-security-solution'), $this->options['pw_complexity_exemption_length']);
			case self::E_COMMON:
			...
			case self::E_WRONG_CURRENT:
				return __("You have entered the wrong current password.", 'login-security-solution');
			case self::E_EMPTY_CURRENT:
				return __("You must enter your current password.", 'login-security-solution');
			case self::E_CHARS_DIFF:
				return sprintf(__("You must change at least %d characters of your password.", 'login-security-solution'), $this->options['pw_change_char_diff']);
